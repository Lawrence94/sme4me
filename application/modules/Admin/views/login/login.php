...
<html>
  <head>
    ...
    <title>Solomon Max | Log in</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>SolomonMax</b> Admin Panel</a>
      ...
      <div class="login-box-body">
        ...
        <form action="<?= site_url('') ?>" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="password" type="password" name="txtpassword" class="form-control" placeholder="Password">
